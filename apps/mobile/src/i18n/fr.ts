...
export const fr = {
  ...
  voice: {
    ...
    listening: 'Je t’écoute… glisse vers le haut pour bloquer',
    locked: 'Micro bloqué : parle, puis touche le micro pour envoyer',
    slideToLock: 'Glisse vers le haut pour bloquer le micro',
    analysing: 'J’analyse…',
    ...
    tooShort: 'Garde le micro appuyé pendant que tu parles.',
    ...
    decouvreurDeadEnd: 'Dis « revenir à » suivi d’une question déjà posée.',
    decouvreurCharacter: 'Dis le nom.',
    backWhere: 'Revenir où ? Dis « revenir à » suivi de la question.',
    tireurHint: 'Dis OUI, NON, un long OUIIII… ou « question ».',
    guessHint: 'Dis OUI si c’est le nom, NON sinon.',
    mistakeHint: 'Dis « question » pour revenir d’une liste, « question question » pour deux, trois fois pour trois.',
    // Borderline OUI / OUIOUIOUI (GRAPH_SPECIFICATION §1): ask again, out loud.
