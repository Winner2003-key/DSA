-- =============================================================================
-- DSA — 03_game_ux.sql — UPGRADE for a project that already ran 00 and 01
--
-- * Paste the WHOLE file into Supabase → SQL Editor and click Run.
-- * Only for a project set up BEFORE the game UX update (S3b). A new project
--   runs the regenerated 00_all_migrations.sql instead, which already contains
--   this change.
-- * Safe to run more than once.
-- * Expected result: "Success. No rows returned". Then run 90_tests.sql:
--   one row, ALL DSA TESTS PASSED.
--
-- Same content as supabase/migrations/0006_game_ux.sql (keep them identical).
-- =============================================================================
